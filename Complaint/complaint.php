        ...
        <form class="form-signin" action="complaintAction.php" method="post" autocomplete="off">
            <div class="form-section ">
                <div class="form-elements">
                    ...
                    <input type="text" id="complain_subject" name="subject" class="form-control" placeholder="Complaint Subject" required autofocus>
                </div>
                <div class="form-elements">
                    <label for="inputName" class="input-label">Write your complaint here</label>
                    <textarea id="complaintDesc" name="complaintDesc" class="form-control" placeholder="Describe your complaint..." required autofocus></textarea>
                </div>
            </div>
...
<section>
    ...
    <?php
        if (isset($_GET["s"])) {
        echo "<script> alert('You deleted your complaint...')</script>";
    }
    ?>
</section>
