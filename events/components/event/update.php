...
$SelSql = "SELECT * FROM `tblevents` WHERE id=$id";
...
if (isset($_POST) & !empty($_POST)) {
	...
	// Execute query
	$query = "UPDATE `tblevents` SET name='$name', description='$description', category='$category', start_date='$start_date', end_date='$end_date', sponsors='$sponsors' WHERE id='$id'";
